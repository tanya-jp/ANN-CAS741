...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
\code{get\_train\_dataset} & - & \code{train\_data} & \code{UnableToLoad} \\
\code{get\_test\_dataset} & - & \code{test\_data} & \code{UnableToLoad} \\
\hline
\end{tabular}
\end{center}
...
\textbf{Name} & \textbf{In} & \textbf{Out} & \textbf{Exceptions} \\
\hline
\code{train\_and\_test} & \code{gradientsArrays, train\_data, test\_data} & \code{[weights, biases]} & -\\
\code{set\_layers} & - & - & -\\
\hline
\end{tabular}
\end{center}
...
\begin{itemize}
  ...
  model architecture and are saved in a list named layers.
\end{itemize}
...
\begin{itemize}
  ...
  \item output: Returns a data structure including weights and biases of trained model.
  \item exception: None.
\end{itemize}
...
\begin{itemize}
  ...
  \begin{itemize}
    \item transition: Allocates random normal Weights and zero biases for each layer.
